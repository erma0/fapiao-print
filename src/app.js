...
function openInvModal(i) {
  ...
  document.getElementById('invModalBody').innerHTML =
    ...
    '<div class="row"><label class="lbl">含税价</label><div style="flex:1;display:flex;gap:4px;align-items:center"><span style="font-size:14px;font-weight:600;color:var(--success)">\u00A5</span><input type="number" id="mAmountTax" value="' + (f.amountTax || '') + '" min="0" step="0.01" placeholder="0.00" style="flex:1;text-align:right;min-width:80px"></div></div>' +
    '<div class="row"><label class="lbl">不含税</label><div style="flex:1;display:flex;gap:4px;align-items:center"><span style="font-size:14px;font-weight:600;color:var(--text-muted)">\u00A5</span><input type="number" id="mAmountNoTax" value="' + (f.amountNoTax || '') + '" min="0" step="0.01" placeholder="0.00" style="flex:1;text-align:right;min-width:80px"></div></div>' +
    '<div class="row"><label class="lbl">税额</label><div style="flex:1;display:flex;gap:4px;align-items:center"><span style="font-size:14px;font-weight:600;color:var(--warning,orange)">\u00A5</span><input type="number" id="mTaxAmount" value="' + (f.taxAmount || '') + '" min="0" step="0.01" placeholder="0.00" style="flex:1;text-align:right;min-width:80px"></div></div>' +
