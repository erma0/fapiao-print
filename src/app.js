...
function openInvModal(i) {
  ...
  document.getElementById('invModalBody').innerHTML =
    ...
    '<div class="row"><label class="lbl">含税价</label><div style="flex:1;display:flex;gap:4px;align-items:center"><span style="font-size:14px;font-weight:600;color:var(--success)">\u00A5</span><input type="number" id="mAmountTax" value="' + (f.amountTax || '') + '" min="0" step="0.01" placeholder="0.00" style="width:130px;text-align:right"></div></div>' +
    '<div class="row"><label class="lbl">不含税</label><div style="flex:1;display:flex;gap:4px;align-items:center"><span style="font-size:14px;font-weight:600;color:var(--text-muted)">\u00A5</span><input type="number" id="mAmountNoTax" value="' + (f.amountNoTax || '') + '" min="0" step="0.01" placeholder="0.00" style="width:130px;text-align:right"></div></div>' +
    '<div class="row"><label class="lbl">税额</label><div style="flex:1;display:flex;gap:4px;align-items:center"><span style="font-size:14px;font-weight:600;color:var(--warning,orange)">\u00A5</span><input type="number" id="mTaxAmount" value="' + (f.taxAmount || '') + '" min="0" step="0.01" placeholder="0.00" style="width:130px;text-align:right"></div></div>' +
    '<div class="row"><label class="lbl">发票号码</label><div style="display:flex;gap:4px;align-items:center;flex:1"><input type="text" id="mInvoiceNo" value="' + escHtml(f.invoiceNo || '') + '" placeholder="自动识别" style="flex:1;font-size:11px;font-family:monospace"></div></div>' +
    '<div class="row"><label class="lbl">开票日期</label><div style="display:flex;gap:4px;align-items:center;flex:1"><input type="text" id="mInvoiceDate" value="' + escHtml(f.invoiceDate || '') + '" placeholder="自动识别" style="flex:1;font-size:11px"></div></div>' +
    '<div class="row"><label class="lbl">购买方</label><div style="display:flex;gap:4px;align-items:center;flex:1"><input type="text" id="mBuyer" value="' + escHtml(f.buyerName || '') + '" placeholder="自动识别" style="flex:1;font-size:11px"></div></div>' +
    '<div class="row"><label class="lbl">购方代码</label><div style="display:flex;gap:4px;align-items:center;flex:1"><input type="text" id="mBuyerCreditCode" value="' + escHtml(f.buyerCreditCode || '') + '" placeholder="自动识别" style="flex:1;font-size:11px;font-family:monospace"></div></div>' +
    '<div class="row"><label class="lbl">销售方</label><div style="display:flex;gap:4px;align-items:center;flex:1"><input type="text" id="mSeller" value="' + escHtml(f.sellerName || '') + '" placeholder="自动识别" style="flex:1;font-size:11px"></div></div>' +
    '<div class="row"><label class="lbl">信用代码</label><div style="display:flex;gap:4px;align-items:center;flex:1"><input type="text" id="mCreditCode" value="' + escHtml(f.sellerCreditCode || '') + '" placeholder="自动识别" style="flex:1;font-size:11px;font-family:monospace"></div></div>' +
